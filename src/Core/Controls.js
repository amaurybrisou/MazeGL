    ...
    AvatarControls : (function () {
        return function (object, instance) {
            ...
            window.document.addEventListener(
                'mousemove', window.bind(object, avatar_controls.onMouseMove), false);
            window.document.addEventListener(
                'mousedown', window.bind(object, avatar_controls.onMouseDown), false);
            window.document.addEventListener(
                'mouseup', window.bind(object, avatar_controls.onMouseUp), false);
            window.document.addEventListener(
                'keydown', window.bind(object, avatar_controls.onKeyDown), false);
            window.document.addEventListener(
                'keyup', window.bind(object, avatar_controls.onKeyUp), false);
            //window.document.addEventListener(
                //'mousewheel', window.bind(object, avatar_controls.onMouseWheel), false);
