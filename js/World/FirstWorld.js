...
window.mmo.World.FirstWorld = function() {
    ...
    //sun
    window.mmo.SUN                      = window.mmo.World_Objects.Sun_obj;
    //fog
    window.mmo.FOG_DENSITY              = 0.00001;
